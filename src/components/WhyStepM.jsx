        ...
        <section>
            <main className="whyus" id="whyus">
                <header>
                    ...
                    <p> <strong>Share My Plan</strong>  makes it simple,we connect you with active, motivated learners worldwide.
                ...
                <ul className="features-list">
                    ...
                    <li>
                        ...
                        <p>We match you instantly in a Family Plan</p>
